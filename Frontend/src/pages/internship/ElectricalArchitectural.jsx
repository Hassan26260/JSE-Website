...
const ElectricalArchitectural = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            data.append('internshipTitle', 'Electrical & Architectural');
            ...
            <section className="internship-hero-section">
                <div className="internship-hero-content">
                    <div className="internship-breadcrumbs">
                        internship &gt; <span>Electrical & Architectural</span>
                    </div>
                    <h1 className="internship-hero-title">Electrical & Architectural</h1>
                </div>
            </section>
                ...
                <div className="internship-split-container">
                    ...
                    <div className="internship-text-side">
                        ...
                        <div className="internship-desc">
                            <p>
                                Join our Electrical & Architectural internship program to gain hands-on experience in modern design workflows. You will work alongside experienced engineers on real-world projects, applying theoretical knowledge to practical challenges.
                            </p>
                            <p>
...
export default ElectricalArchitectural;
