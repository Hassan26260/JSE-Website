...
const OtherInternships = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            data.append('internshipTitle', 'Other Departments');
            ...
            <section className="internship-hero-section">
                <div className="internship-hero-content">
                    <div className="internship-breadcrumbs">
                        internship &gt; <span>Other</span>
                    </div>
                    <h1 className="internship-hero-title">Other Internship Departments</h1>
                </div>
            </section>
            ...
            <section className="internship-content-section">
                <div className="internship-split-container">
                    ...
                    <div className="internship-text-side">
                        <h2 className="internship-heading">Build Your Career the Smart Way</h2>
                        <div className="internship-desc">
                            <p>
                                Join our comprehensive internship program to gain hands-on experience in various engineering disciplines. You will work alongside experienced engineers on real-world projects, applying theoretical knowledge to practical challenges.
                            </p>
                            <p>
                                Our program focuses on developing core competencies in specialized software, on-site problem solving, and project estimation. JSE allows you to explore diverse aspects of the industry and build a strong foundation for your future.
                            </p>
                        </div>
...
export default OtherInternships;
