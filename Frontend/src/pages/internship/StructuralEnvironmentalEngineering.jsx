...
const StructuralEnvironmentalEngineering = () => {
  // Form State
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      data.append('internshipTitle', 'Structural & Environmental Engineering');
      ...
      <section className="internship-hero-section">
        <div className="internship-hero-content">
          <div className="internship-breadcrumbs">
            internship &gt; <span>Structural & Environmental Engineering</span>
          </div>
          <h1 className="internship-hero-title">Structural & Environmental Engineering</h1>
        </div>
      </section>
...
export default StructuralEnvironmentalEngineering;
