...
import internImage from '../../assets/images-home/intern-dep/civil.JPG';
...
const CivilEngineering = () => {
  ...
  const programDetails = [
    {
      ...
      content: "A comprehensive 100-day journey designed to transform you from a student into a site-ready civil engineer. The curriculum is paced to ensure deep learning without overwhelming you."
    },
    {
      title: "Program Scope",
      content: "Hands-on experience with real-world MEP projects using industry-standard tools like AutoCAD, Revit, and Tekla Structures. You will work on actual project simulations."
    },
    {
      title: "Placement Guarantee",
      content: "We don't just train you; we launch your career. 100% placement assistance with top construction firms upon successful completion of the program."
    },
    {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      data.append('internshipTitle', 'Civil Engineering');
      ...
      <section className="internship-content-section">
        <div className="internship-split-container">
          ...
          <div className="internship-text-side">
            ...
            <button className="apply-btn" onClick={scrollToForm} style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem' }}>
              Apply Now
              {/* Inline SVG Arrow */}
        ...
        <div className="highlights-container" style={{ justifyContent: 'center' }}>
          ...
          <div className="highlights-content-side" style={{ width: '100%', maxWidth: '1600px' }}>
            ...
            <p className="highlights-desc" style={{ textAlign: 'center', margin: '0 auto 4rem auto', maxWidth: '800px', fontSize: '1.2rem', color: '#475569' }}>
              A structured pathway to professional excellence. Explore the key details of our Civil Engineering Internship below.
            </p>
