...
const Skyscrapers = () => {
    ...
    return (
        <div className="skyscrapers-page">
            {/* Hero Section */}
            <section className="skyscrapers-hero-section" style={{ backgroundImage: `url(${heroImage})` }}>
                <div className="skyscrapers-hero-overlay"></div>
                <div className="skyscrapers-hero-content">
                    {/* Breadcrumbs */}
                    <div className="skyscrapers-breadcrumbs">
                        Home &gt; Industries &gt; <span>Skyscrapers</span>
                    </div>

                    <h1 className="skyscrapers-hero-title">Skyscrapers</h1>
                    <p className="skyscrapers-hero-desc">
                        BIM Solutions for Architectural Projects
                    </p>
                    <button onClick={scrollToForm} className="skyscrapers-hero-cta" style={{ cursor: 'pointer', border: 'none', font: 'inherit' }}>Hire Us</button>
                </div>
            </section>

            {/* Industry Focus Section */}
            <section className="skyscrapers-focus-section">
                <div className="skyscrapers-focus-container">
                    <div className="skyscrapers-focus-text">
                        <span className="dash-tagline">INDUSTRY FOCUS</span>
                        <h2 className="skyscrapers-focus-title">Why BIM for your Architectural Projects?</h2>
                        <div className="skyscrapers-focus-desc">
                            <p>
                    ...
                    <div className="skyscrapers-focus-image-wrapper">
                        <div className="skyscrapers-image-back"></div>
                        <img
                            src={contentImage}
                            alt="BIM for Skyscrapers"
                            className="skyscrapers-focus-img"
                            loading="lazy"
                            decoding="async"
                        />
                    </div>
            ...
            <section className="skyscrapers-facilities-section">
                <div className="skyscrapers-facilities-container">
                    {/* Left Sticky Content */}
                    <div className="skyscrapers-sticky-left">
                        <div className="skyscrapers-header-content">
                            <div className="dash-tagline">ARCHITECTURAL FACILITIES</div>
                            <h2 className="skyscrapers-section-title">Architectural Facilities Benefiting</h2>
                            <div className="skyscrapers-decorative-line"></div>
                        </div>
                    </div>

                    {/* Right Scrollable Cards */}
                    <div className="skyscrapers-cards-list">
                        {ARCH_FACILITIES_DATA.map((item, index) => (
                            <div key={index} className="skyscrapers-facility-card">
                                <div className="skyscrapers-card-image-wrapper">
                                    <img src={item.img} alt={item.title} className="skyscrapers-card-img" loading="lazy" decoding="async" />
                                </div>
                                <div className="skyscrapers-card-content">
                                    <h3 className="skyscrapers-card-title">{item.title}</h3>
                                    <p className="skyscrapers-card-desc">{item.desc}</p>
                                </div>
                            </div>
                        ))}
                    </div>
            ...
            <section className="skyscrapers-offer-section">
                <div className="skyscrapers-offer-container">
                    {/* Left Scrollable Cards (Icons) */}
                    <div className="skyscrapers-cards-list offer-cards-left">
                        {OFFER_DATA.map((item, index) => (
                            <div key={index} className="skyscrapers-facility-card offer-card">
                                <div className="skyscrapers-icon-wrapper">
                                    {item.icon}
                                </div>
                                <div className="skyscrapers-card-content">
                                    <h3 className="skyscrapers-card-title">{item.title}</h3>
                    ...
                    <div className="skyscrapers-sticky-right">
                        <div className="skyscrapers-header-content">
                            <div className="dash-tagline">WHAT WE OFFER</div>
                            <h2 className="skyscrapers-section-title">JSE Architectural BIM Services</h2>
                            <div className="skyscrapers-decorative-line"></div>
                        </div>
                    </div>
                </div>
            ...
            <section className="skyscrapers-business-section">
                <div className="skyscrapers-business-container">
            ...
            <section className="skyscrapers-partner-section">
                <div className="skyscrapers-partner-container">
                    <div className="skyscrapers-partner-image-side">
                        <img src={partnerImage} alt="Trusted Partner" className="skyscrapers-partner-img" loading="lazy" decoding="async" />
                    </div>
                    <div className="skyscrapers-partner-content-side">
                        <div className="dash-tagline">ARCHITECTURAL FACILITIES</div>
                        <h2 className="skyscrapers-heading-blue">Your Trusted Partner in Architectural</h2>
                        <div className="skyscrapers-blob-text">
            ...
            {/* Why Choose JSE Section (Skyscrapers) */}
            <section className="skyscrapers-why-section">
                <div className="skyscrapers-header-center">
                    <span className="dash-tagline" style={{ justifyContent: 'center' }}>WHY CHOOSE JSE?</span>
                    <h2 className="skyscrapers-heading-blue" style={{ fontSize: '3rem', textAlign: 'center' }}>Why Choose JSE for BIM in the Architectural Industry?</h2>
                </div>

                <div className="skyscrapers-why-grid">
                    {ARCH_WHY_CHOOSE_DATA.map((item, index) => (
                        <div key={index} className="skyscrapers-why-card">
                            <div className="skyscrapers-icon-circle">
                                {item.icon}
                            </div>
                            <h4 className="skyscrapers-card-title">{item.title}</h4>
                            <p className="skyscrapers-card-desc">{item.desc}</p>
                        </div>
                    ))}
                </div>
            ...
            <section className="skyscrapers-tech-section">
                <div className="skyscrapers-tech-container">
                    <div className="skyscrapers-header-center">
                        <span className="dash-tagline" style={{ justifyContent: 'center' }}>TECHNOLOGIES</span>
                        <h2 className="skyscrapers-heading-blue" style={{ fontSize: '3rem', textAlign: 'center' }}>Innovative Tools We Use</h2>
                    </div>

                    <div className="skyscrapers-tech-grid">
                        {ARCH_TECH_DATA.map((tech, index) => (
                            <div key={index} className="skyscrapers-tech-card">
                                <div className="skyscrapers-tech-logo-wrapper" style={{ background: tech.bg }}>
                                    {tech.img ? (
                                        <img src={tech.img} alt={tech.name} className="skyscrapers-tech-logo-img" loading="lazy" decoding="async" />
                                    ) : (
                                        <span className="skyscrapers-tech-abbr">{tech.abbr}</span>
                                    )}
                                </div>
                                <p className="skyscrapers-tech-name">{tech.name}</p>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            {/* Form Section */}
            <section id="contact-form" className="skyscrapers-form-section">
                <div className="skyscrapers-form-container">
                    {/* Left Side: Title & Info */}
                    <div className="skyscrapers-form-info-side">
                        <h2 className="skyscrapers-form-heading">Start Your Project</h2>
                        <p className="skyscrapers-form-subtext">
                            Ready to transform your architectural vision with our BIM expertise? Contact us today to discuss your project needs.
                        </p>

                        <div className="skyscrapers-form-contact-details">
                            <p className="skyscrapers-form-email">info@jseengineering.com</p>
                        </div>

                        {/* Social Icons (Reused SVG paths) */}
                        <div className="skyscrapers-form-socials">
                            <div className="skyscrapers-social-circle">
                    ...
                    {/* Right Side: Form */}
                    <div className="skyscrapers-form-input-side">
                        <form onSubmit={handleSubmit} className="skyscrapers-form">
                            <div className="skyscrapers-form-group">
                                ...
                                <input
                                    ...
                                    required
                                    className="skyscrapers-form-input-line"
                                />
                            </div>
                            <div className="skyscrapers-form-group">
                            ...
                            <button type="submit" className="skyscrapers-form-submit-btn">Submit</button>
                        </form>
                    </div>
                </div>
            </section>
