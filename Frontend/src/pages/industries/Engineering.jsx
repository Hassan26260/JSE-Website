...
const Engineering = () => {
    ...
    return (
        <div className="engineering-page">
            ...
            <section className="engineering-hero-section" style={{ backgroundImage: `url(${heroImage})` }}>
                <div className="engineering-hero-overlay"></div>
                <div className="engineering-hero-content">
                    {/* Breadcrumbs */}
                    <div className="engineering-breadcrumbs">
                        Home &gt; Industries &gt; <span>Engineering</span>
                    </div>

                    <h1 className="engineering-hero-title">Engineering</h1>
                    <p className="engineering-hero-desc">
                        BIM Solutions for Engineering Facilities
                    </p>
                    <button onClick={scrollToForm} className="engineering-hero-cta" style={{ cursor: 'pointer', border: 'none', font: 'inherit' }}>Hire Us</button>
                </div>
            </section>

            {/* Why BIM for Engineering? - Adapted from SecondmentTeam 'Our Service' */}
            <section className="engineering-concept-section">
                <div className="engineering-concept-container">
                    <div className="engineering-concept-text">
                        <span className="dash-tagline">INDUSTRY FOCUS</span>
                        <h2 className="engineering-concept-title">Why BIM for Engineering?</h2>
                        <div className="engineering-concept-desc">
                            <p>
                    ...
                    <div className="engineering-concept-image-wrapper">
                        <div className="engineering-image-back"></div>
                        <img
                            src={contentImage}
                            alt="BIM for Engineering"
                            className="engineering-concept-img"
                            loading="lazy"
                            decoding="async"
                        />
                    </div>
            ...
            {/* Engineering Facilities Section (Existing) */}
            <section className="engineering-facilities-section">
                <div className="engineering-facilities-container">
                    {/* Left Sticky Content */}
                    <div className="engineering-sticky-left">
                        <div className="engineering-header-content">
                            <p className="dash-tagline">AREAS OF EXPERTISE</p>
                            <h2 className="engineering-section-title">Engineering Facilities We Serve</h2>
                            <p className="engineering-tagline">
                                Tailored BIM solutions for diverse medical environments, ensuring precision where it matters most.
                            </p>
                            <div className="engineering-decorative-line"></div>
                        </div>
                    </div>

                    {/* Right Scrollable Cards */}
                    <div className="engineering-cards-list">
                        {FACILITIES_DATA.map((item, index) => (
                            <div key={index} className="engineering-facility-card">
                                <div className="engineering-card-image-wrapper">
                                    <img src={item.img} alt={item.title} className="engineering-card-img" loading="lazy" decoding="async" />
                                </div>
                                <div className="engineering-card-content">
                                    <h3 className="engineering-card-title">{item.title}</h3>
                                    <p className="engineering-card-desc">{item.desc}</p>
                                </div>
                            </div>
                        ))}
                    </div>
            ...
            <section className="engineering-hiring-section">
                <div className="engineering-hiring-container">
                    <div className="engineering-hiring-image-side">
                        <img src={recruitmentImage} alt="Join Our Engineering Team" className="engineering-hiring-img" loading="lazy" decoding="async" />
                    </div>
                    <div className="engineering-hiring-content-side">
                        <div className="dash-tagline">CAREERS</div>
                        <h2 className="section-heading-blue">Join Our Engineering Team</h2>
                        <div className="section-blob-text">
                            ...
                            <br />
                            <a href="/career" className="engineering-hero-cta" style={{ display: 'inline-block', fontSize: '0.9rem', padding: '0.8rem 2rem' }}>View Openings</a>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="engineering-business-section">
                <div className="engineering-business-container">
            ...
            <section className="engineering-why-section">
                <div className="engineering-header-center">
                    <span className="dash-tagline" style={{ justifyContent: 'center' }}>WHY CHOOSE JSE?</span>
                    <h2 className="business-heading" style={{ color: '#144AE0', fontSize: '3rem', textAlign: 'center' }}>Why Choose JSE for BIM in Engineering?</h2>
                </div>

                <div className="engineering-why-grid">
                    {/* specialized expertise */}
                    <div className="engineering-why-card">
                        <div className="engineering-icon-circle">
                        ...
                        <h4 className="engineering-card-title">Specialized Expertise</h4>
                        <p className="engineering-card-desc">We understand the complexities of healthcare facilities and design systems that meet the strictest standards of safety and efficiency.</p>
                    </div>
                    ...
                    <div className="engineering-why-card">
                        ...
                        <h4 className="engineering-card-title">Advanced Technology</h4>
                        <p className="engineering-card-desc">We utilize the latest BIM software tools to create detailed, accurate models that streamline the design and construction process.</p>
                    </div>
                    ...
                    <div className="engineering-why-card">
                        ...
                        <h4 className="engineering-card-title">Collaborative Partnership</h4>
                        <p className="engineering-card-desc">We work closely with your team to ensure every aspect of your project aligns with your vision and operational needs.</p>
                    </div>
                    ...
                    <div className="engineering-why-card">
                        ...
                        <h4 className="engineering-card-title">Proven Success</h4>
                        <p className="engineering-card-desc">With three decades of experience and a portfolio of over 6,000+ successful projects, JSE is a trusted partner in delivering world-class healthcare facilities.</p>
                    </div>
                </div>
            </section>

            {/* Innovative Software Tools Section */}
            <section className="engineering-tech-section">
                <div className="engineering-tech-container">
                    <div className="engineering-header-center">
                    ...
                    <div className="engineering-tech-grid">
                        {HEALTHCARE_TECH_DATA.map((tech, index) => (
                            <div key={index} className="engineering-tech-card">
                                <div className="engineering-tech-logo-wrapper" style={{ background: tech.bg }}>
                                    {tech.img ? (
                                        <img src={tech.img} alt={tech.name} className="engineering-tech-logo-img" loading="lazy" decoding="async" />
                                    ) : (
                                        <span className="engineering-tech-abbr">{tech.abbr}</span>
                                    )}
                                </div>
                                <p className="engineering-tech-name">{tech.name}</p>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            {/* Form Section */}
            <section id="contact-form" className="engineering-form-section">
                <div className="engineering-form-container">
                    {/* Left Side: Title & Info */}
                    <div className="engineering-form-info-side">
                        <h2 className="engineering-form-heading">Start Your Project</h2>
                        <p className="engineering-form-subtext">
                            Ready to optimize your workflow with JSE's Engineering BIM services? Fill out the details and we'll get in touch with you shortly.
                        </p>

                        <div className="engineering-form-contact-details">
                            <p className="engineering-form-email">info@jseengineering.com</p>
                        </div>

                        <div className="engineering-form-socials">
                            <div className="engineering-social-circle">
                    ...
                    {/* Right Side: Form */}
                    <div className="engineering-form-input-side">
                        <form onSubmit={handleSubmit} className="engineering-form">
                            <div className="engineering-form-group">
                                ...
                                <input
                                    ...
                                    required
                                    className="engineering-form-input-line"
                                />
                            </div>
                            <div className="engineering-form-group">
                            ...
                            <button type="submit" className="engineering-form-submit-btn">Submit</button>
                        </form>
                    </div>
                </div>
            </section>
