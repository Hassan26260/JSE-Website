...
const Architecture = () => {
    ...
    return (
        <div className="architecture-page">
            {/* Hero Section */}
            <section className="architecture-hero-section" style={{ backgroundImage: `url(${heroImage})` }}>
                <div className="architecture-hero-overlay"></div>
                <div className="architecture-hero-content">
                    {/* Breadcrumbs */}
                    <div className="architecture-breadcrumbs">
                        Home &gt; Industries &gt; <span>Architecture</span>
                    </div>

                    <h1 className="architecture-hero-title">Architecture</h1>
            ...
            <section className="architecture-focus-section">
                <div className="architecture-focus-container">
                    <div className="architecture-focus-text">
                        <span className="dash-tagline">INDUSTRY FOCUS</span>
                        <h2 className="architecture-focus-title">Why BIM for your Architectural Projects?</h2>
                        <div className="architecture-focus-desc">
                            <p>
                    ...
                    <div className="architecture-focus-image-wrapper">
                        <div className="architecture-image-back"></div>
                        <img
                            src={contentImage}
                            alt="BIM for Architecture"
                            className="architecture-focus-img"
                            loading="lazy"
                        />
                    </div>
                </div>
            ...
            <section className="architecture-facilities-section">
                <div className="architecture-facilities-container">
                    {/* Left Sticky Content */}
                    <div className="architecture-sticky-left">
                        <div className="architecture-header-content">
                            <div className="dash-tagline">ARCHITECTURAL FACILITIES</div>
                            <h2 className="architecture-section-title">Architectural Facilities Benefiting</h2>
                            <div className="architecture-decorative-line"></div>
                        </div>
                    </div>

                    {/* Right Scrollable Cards */}
                    <div className="architecture-cards-list">
                        {ARCH_FACILITIES_DATA.map((item, index) => (
                            <div key={index} className="architecture-facility-card">
                                <div className="architecture-card-image-wrapper">
                                    <img src={item.img} alt={item.title} className="architecture-card-img" loading="lazy" />
                                </div>
                                <div className="architecture-card-content">
                                    <h3 className="architecture-card-title">{item.title}</h3>
                                    <p className="architecture-card-desc">{item.desc}</p>
                                </div>
                            </div>
                        ))}
                    </div>
            ...
            <section className="architecture-offer-section">
                <div className="architecture-offer-container">
                    {/* Left Scrollable Cards (Icons) */}
                    <div className="architecture-cards-list offer-cards-left">
                        {OFFER_DATA.map((item, index) => (
                            <div key={index} className="architecture-facility-card offer-card">
                    ...
                    <div className="architecture-sticky-right">
                        <div className="architecture-header-content">
                            <div className="dash-tagline">WHAT WE OFFER</div>
                            <h2 className="architecture-section-title">JSE Architectural BIM Services</h2>
                            <div className="architecture-decorative-line"></div>
                        </div>
                    </div>
                </div>
            ...
            <section className="architecture-business-section">
                <div className="architecture-business-container">
            ...
            <section className="architecture-partner-section">
                <div className="architecture-partner-container">
                    <div className="architecture-partner-image-side">
                        <img src={partnerImage} alt="Trusted Partner" className="architecture-partner-img" loading="lazy" />
                    </div>
                    <div className="architecture-partner-content-side">
                        <div className="dash-tagline">ARCHITECTURAL FACILITIES</div>
                        <h2 className="architecture-heading-blue">Your Trusted Partner in Architectural</h2>
                        <div className="architecture-blob-text">
            ...
            {/* Why Choose JSE Section (Architecture) */}
            <section className="architecture-why-section">
                <div className="architecture-header-center">
                    <span className="dash-tagline" style={{ justifyContent: 'center' }}>WHY CHOOSE JSE?</span>
                    <h2 className="architecture-heading-blue" style={{ fontSize: '3rem', textAlign: 'center' }}>Why Choose JSE for BIM in the Architectural Industry?</h2>
                </div>

                <div className="architecture-why-grid">
                    {ARCH_WHY_CHOOSE_DATA.map((item, index) => (
                        <div key={index} className="architecture-why-card">
                            <div className="architecture-icon-circle">
                                {item.icon}
                            </div>
                            <h4 className="architecture-card-title">{item.title}</h4>
                            <p className="architecture-card-desc">{item.desc}</p>
                        </div>
                    ))}
                </div>
            ...
            <section id="contact-form" className="architecture-form-section">
                <div className="architecture-form-container">
                    ...
                    <div className="architecture-form-info-side">
                        <h2 className="architecture-form-heading">Start Your Project</h2>
                        <p className="architecture-form-subtext">
                            Ready to transform your architectural vision with our BIM expertise? Contact us today to discuss your project needs.
                        </p>

                        <div className="architecture-form-contact-details">
                            <p className="architecture-form-email">info@jseengineering.com</p>
                        </div>

                        {/* Social Icons (Reused SVG paths) */}
                        <div className="architecture-form-socials">
                            <div className="architecture-social-circle">
                    ...
                    {/* Right Side: Form */}
                    <div className="architecture-form-input-side">
                        <form onSubmit={handleSubmit} className="architecture-form">
                            <div className="architecture-form-group">
                                ...
                                <input
                                    ...
                                    required
                                    className="architecture-form-input-line"
                                />
                            </div>
                            <div className="architecture-form-group">
                            ...
                            <button type="submit" className="architecture-form-submit-btn">Submit</button>
                        </form>
                    </div>
                </div>
            </section>
