...
const Educational = () => {
    ...
    return (
        <div className="educational-page">
            ...
            <section className="educational-hero-section" style={{ backgroundImage: `url(${heroImage})` }}>
                <div className="educational-hero-overlay"></div>
                <div className="educational-hero-content">
                    {/* Breadcrumbs */}
                    <div className="educational-breadcrumbs">
                        Home &gt; Industries &gt; <span>Educational</span>
                    </div>

                    <h1 className="educational-hero-title">Educational</h1>
            ...
            {/* Why BIM for Educational? - Adapted from SecondmentTeam 'Our Service' */}
            <section className="educational-concept-section">
                <div className="educational-concept-container">
                    <div className="educational-concept-text">
                        <span className="dash-tagline">INDUSTRY FOCUS</span>
                        <h2 className="educational-concept-title">Why BIM for Educational?</h2>
                        <div className="educational-concept-desc">
                            <p>
                    ...
                    <div className="educational-concept-image-wrapper">
                        <div className="educational-image-back"></div>
                        <img
                            src={contentImage}
                            alt="BIM for Educational"
                            className="educational-concept-img"
                            loading="lazy"
                            decoding="async"
                        />
                    </div>
            ...
            {/* Educational Facilities Section (Existing) */}
            <section className="educational-facilities-section">
                <div className="educational-facilities-container">
                    {/* Left Sticky Content */}
                    <div className="educational-sticky-left">
                        <div className="educational-header-content">
                            <p className="dash-tagline">AREAS OF EXPERTISE</p>
                            <h2 className="educational-section-title">Educational Facilities We Serve</h2>
                            <p className="educational-tagline">
                                Tailored BIM solutions for diverse medical environments, ensuring precision where it matters most.
                            </p>
                            <div className="educational-decorative-line"></div>
                        </div>
                    </div>

                    {/* Right Scrollable Cards */}
                    <div className="educational-cards-list">
                        {FACILITIES_DATA.map((item, index) => (
                            <div key={index} className="educational-facility-card">
                                <div className="educational-card-image-wrapper">
                                    <img src={item.img} alt={item.title} className="educational-card-img" loading="lazy" decoding="async" />
                                </div>
                                <div className="educational-card-content">
                                    <h3 className="educational-card-title">{item.title}</h3>
                                    <p className="educational-card-desc">{item.desc}</p>
                                </div>
                            </div>
                        ))}
                    </div>
            ...
            <section className="educational-hiring-section">
                <div className="educational-hiring-container">
                    <div className="educational-hiring-image-side">
                        <img src={recruitmentImage} alt="Join Our Educational Team" className="educational-hiring-img" loading="lazy" decoding="async" />
                    </div>
                    <div className="educational-hiring-content-side">
                        <div className="dash-tagline">CAREERS</div>
                        <h2 className="section-heading-blue">Join Our Educational Team</h2>
                        <div className="section-blob-text">
                            ...
                            <br />
                            <a href="/career" className="educational-hero-cta" style={{ display: 'inline-block', fontSize: '0.9rem', padding: '0.8rem 2rem' }}>View Openings</a>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="educational-bento-section">
                <div className="educational-bento-container">
                    <div className="educational-bento-header">
                        <span className="dash-tagline" style={{ justifyContent: 'center' }}>OUR CAPABILITIES</span>
                        <h2 className="educational-bento-heading">Comprehensive Design Engineering Services for Educational</h2>
                    </div>

                    <div className="educational-bento-grid">
                        {COMPREHENSIVE_SERVICES.map((item, index) => (
                            <div
                                key={index}
                                className={`educational-bento-card hb-${item.type} ${item.span === 'col-2' ? 'hb-span-2-col' : ''}`}
            ...
            <section className="educational-business-section">
                <div className="educational-business-container">
            ...
            <section className="educational-why-section">
                <div className="educational-header-center">
                    <span className="dash-tagline" style={{ justifyContent: 'center' }}>WHY CHOOSE JSE?</span>
                    <h2 className="business-heading" style={{ color: '#144AE0', fontSize: '3rem', textAlign: 'center' }}>Why Choose JSE for BIM in Educational?</h2>
                </div>

                <div className="educational-why-grid">
                    {/* specialized expertise */}
                    <div className="educational-why-card">
                        <div className="educational-icon-circle">
                        ...
                        <h4 className="educational-card-title">Specialized Expertise</h4>
                        <p className="educational-card-desc">We understand the complexities of healthcare facilities and design systems that meet the strictest standards of safety and efficiency.</p>
                    </div>
                    ...
                    <div className="educational-why-card">
                        ...
                        <h4 className="educational-card-title">Advanced Technology</h4>
                        <p className="educational-card-desc">We utilize the latest BIM software tools to create detailed, accurate models that streamline the design and construction process.</p>
                    </div>
                    ...
                    <div className="educational-why-card">
                        ...
                        <h4 className="educational-card-title">Collaborative Partnership</h4>
                        <p className="educational-card-desc">We work closely with your team to ensure every aspect of your project aligns with your vision and operational needs.</p>
                    </div>
                    ...
                    <div className="educational-why-card">
                        ...
                        <h4 className="educational-card-title">Proven Success</h4>
                        <p className="educational-card-desc">With three decades of experience and a portfolio of over 6,000+ successful projects, JSE is a trusted partner in delivering world-class healthcare facilities.</p>
                    </div>
                </div>
            </section>

            {/* Innovative Software Tools Section */}
            <section className="educational-tech-section">
                <div className="educational-tech-container">
                    <div className="educational-header-center">
                    ...
                    <div className="educational-tech-grid">
                        {HEALTHCARE_TECH_DATA.map((tech, index) => (
                            <div key={index} className="educational-tech-card">
                                <div className="educational-tech-logo-wrapper" style={{ background: tech.bg }}>
                                    {tech.img ? (
                                        <img src={tech.img} alt={tech.name} className="educational-tech-logo-img" loading="lazy" decoding="async" />
                                    ) : (
                                        <span className="educational-tech-abbr">{tech.abbr}</span>
                                    )}
                                </div>
                                <p className="educational-tech-name">{tech.name}</p>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <section className="educational-form-section">
                <div className="educational-form-container">
                    ...
                    <div className="educational-form-info-side">
                        <h2 className="educational-form-heading">Start Your Project</h2>
                        <p className="educational-form-subtext">
                            Ready to optimize your workflow with JSE's Educational BIM services? Fill out the details and we'll get in touch with you shortly.
                        </p>

                        <div className="educational-form-contact-details">
                            <p className="educational-form-email">info@jseengineering.com</p>
                        </div>

                        <div className="educational-form-socials">
                            <div className="educational-social-circle">
                    ...
                    {/* Right Side: Form */}
                    <div className="educational-form-input-side">
                        <form onSubmit={handleSubmit} className="educational-form">
                            <div className="educational-form-group">
                                ...
                                <input
                                    ...
                                    required
                                    className="educational-form-input-line"
                                />
                            </div>
                            <div className="educational-form-group">
                            ...
                            <button type="submit" className="educational-form-submit-btn">Submit</button>
                        </form>
                    </div>
                </div>
            </section>
