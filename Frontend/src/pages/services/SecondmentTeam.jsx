    ...
    <div className="virtual-team-page">
      ...
      <div className="service-hero-split">
        <div className="hero-text-content">
          <span className="hero-small-label">Secondment Team Services</span>
        ...
        <div className="form-container">
          <div className="form-info-side">
            ...
            <p className="form-subtext">
              Ready to optimize your workflow with JSE's Secondment Team? Fill out the details and we'll get in touch with you shortly.
            </p>
