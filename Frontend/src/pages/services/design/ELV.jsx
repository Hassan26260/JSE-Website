    ...
    <div className="arch-bim-page">
      ...
      <section className="arch-hero-section">
        ...
        <div className="arch-hero-content">
          ...
          <h1 className="arch-hero-title">Extra Low Voltage</h1>
        </div>
      </section >
      ...
      < section className="arch-what-section" >
        <div className="arch-what-container">
          ...
          <div className="arch-what-text">
            ...
            <h2 className="arch-what-title">What is Extra Low Voltage?</h2>
      ...
      <section className="arch-services-section">
        <div className="arch-services-container">
          <div className="arch-services-header">
            ...
            <h2 className="arch-services-title">Our Extra Low Voltage Services Include</h2>
        ...
        <div className="form-container">
          ...
          <div className="form-info-side">
            ...
            <p className="form-subtext">
              Ready to optimize your workflow with JSE's Extra Low Voltage services? Fill out the details and we'll get in touch with you shortly.
            </p>
      ...
      <section className="arch-choose-section">
        <div className="arch-choose-container">
          ...
          <div className="arch-choose-left">
            ...
            <h2 className="arch-choose-heading">Why Choose JSE for Extra Low Voltage Engineers?</h2>
