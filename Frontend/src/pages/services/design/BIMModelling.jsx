...
const ICONIC_PROJECTS = ALL_REAL_PROJECTS.slice(0, 6).map(p => ({
  title: p.title,
  img: p.image
}));
      ...
      <section className="arch-hero-section">
        ...
        <div className="arch-hero-content">
          <div className="arch-breadcrumbs">
            Services &gt; Design Services &gt; <span>BIM Modelling</span>
          </div>
          <h1 className="arch-hero-title">BIM Modelling</h1>
        </div>
      </section >
      ...
      < section className="arch-what-section" >
        <div className="arch-what-container">
          ...
          <div className="arch-what-text">
            ...
            <h2 className="arch-what-title">What is BIM Modelling?</h2>
      ...
      <section className="arch-services-section">
        <div className="arch-services-container">
          <div className="arch-services-header">
            ...
            <h2 className="arch-services-title">Our BIM Modelling Services Include</h2>
        ...
        <div className="form-container">
          ...
          <div className="form-info-side">
            ...
            <p className="form-subtext">
              Ready to optimize your workflow with JSE's BIM Modelling services? Fill out the details and we'll get in touch with you shortly.
            </p>
      ...
      <section className="arch-choose-section">
        <div className="arch-choose-container">
          ...
          <div className="arch-choose-left">
            ...
            <h2 className="arch-choose-heading">Why Choose JSE for BIM Modelling Engineers?</h2>
